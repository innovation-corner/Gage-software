...
<h2 class="page-header">Government_project_category</h2>

<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_project_category    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_project_categories'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="parent_category_id" id="parent_category_id" class="form-control" value="{{$model['parent_category_id'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/government_project_categories') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                </div>
            </div>
        </form>
