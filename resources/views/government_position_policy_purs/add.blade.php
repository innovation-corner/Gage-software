...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_position_policy_pur    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_position_policy_purs'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="government_position_policy_id" id="government_position_policy_id" class="form-control" value="{{$model['government_position_policy_id'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
