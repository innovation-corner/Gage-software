...
<div class="panel panel-default">
    <div class="panel-heading">
        View Government_state_pur    </div>

    <div class="panel-body">
                

        <form action="{{ url('/government_state_purs') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="government_state_id" id="government_state_id" class="form-control" value="{{$model['government_state_id'] or ''}}" readonly="readonly">
            </div>
        </div>
