...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_position_project    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_position_projects'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-6">
                    <input type="text" name="project_name" id="project_name" class="form-control" value="{{$model['project_name'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
                <label for="government_project_category_id" class="col-sm-3 control-label">Government Project Category Id</label>
                <div class="col-sm-2">
                    <input type="number" name="government_project_category_id" id="government_project_category_id" class="form-control" value="{{$model['government_project_category_id'] or ''}}">
                </div>
            </div>
                                                                                    <div class="form-group">
                <label for="project_header" class="col-sm-3 control-label">Project Header</label>
                <div class="col-sm-6">
                    <input type="text" name="project_header" id="project_header" class="form-control" value="{{$model['project_header'] or ''}}">
                </div>
            </div>
                                                                                                                                    <div class="form-group">
                <label for="project_description_content" class="col-sm-3 control-label">Project Description Content</label>
                <div class="col-sm-6">
                    <input type="text" name="project_description_content" id="project_description_content" class="form-control" value="{{$model['project_description_content'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
