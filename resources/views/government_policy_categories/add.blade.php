...
<h2 class="page-header">Government_policy_category</h2>

<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_policy_category    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_policy_categories'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/government_policy_categories') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                </div>
            </div>
        </form>
