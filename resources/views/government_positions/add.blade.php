...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_position    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_positions'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="government_category_id" id="government_category_id" class="form-control" value="{{$model['government_category_id'] or ''}}">
                </div>
            </div>
                                                                                                <div class="form-group">
