...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="{{ url('/countries') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="short_code" id="short_code" class="form-control" value="{{$model['short_code'] or ''}}" readonly="readonly">
            </div>
        </div>
