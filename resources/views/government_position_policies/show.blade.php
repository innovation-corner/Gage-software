...
<div class="panel panel-default">
    <div class="panel-heading">
        View Government_position_policy    </div>

    <div class="panel-body">
                

        <form action="{{ url('/government_position_policies') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="policy_name" id="policy_name" class="form-control" value="{{$model['policy_name'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="government_policy_category_id" id="government_policy_category_id" class="form-control" value="{{$model['government_policy_category_id'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="policy_header" id="policy_header" class="form-control" value="{{$model['policy_header'] or ''}}" readonly="readonly">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="policy_description_content" id="policy_description_content" class="form-control" value="{{$model['policy_description_content'] or ''}}" readonly="readonly">
            </div>
        </div>
