...
<h2 class="page-header">Government_official_post_pur</h2>

<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_official_post_pur    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_official_post_purs'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-6">
                    <input type="text" name="remark" id="remark" class="form-control" value="{{$model['remark'] or ''}}">
                                                                        ...
                                                                        <div class="form-group">
                <label for="government_official_post_id" class="col-sm-3 control-label">Government Official Post Id</label>
                <div class="col-sm-2">
                    <input type="number" name="government_official_post_id" id="government_official_post_id" class="form-control" value="{{$model['government_official_post_id'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/government_official_post_purs') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                </div>
            </div>
        </form>
