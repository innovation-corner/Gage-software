...
<div class="panel panel-default">
    <div class="panel-heading">
        View Government_official_post_pur    </div>

    <div class="panel-body">
                

        <form action="{{ url('/government_official_post_purs') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="government_official_post_id" id="government_official_post_id" class="form-control" value="{{$model['government_official_post_id'] or ''}}" readonly="readonly">
            </div>
        </div>
