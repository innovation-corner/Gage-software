...
<div class="panel panel-default">
    <div class="panel-heading">
        View Government_position_project_pur    </div>

    <div class="panel-body">
                

        <form action="{{ url('/government_position_project_purs') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="government_position_project_id" id="government_position_project_id" class="form-control" value="{{$model['government_position_project_id'] or ''}}" readonly="readonly">
            </div>
        </div>
