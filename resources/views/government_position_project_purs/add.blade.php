...
<h2 class="page-header">Government_position_project_pur</h2>

<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_position_project_pur    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_position_project_purs'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-6">
                    <input type="text" name="remark" id="remark" class="form-control" value="{{$model['remark'] or ''}}">
                                                                        ...
                                                                        <div class="form-group">
                <label for="government_position_project_id" class="col-sm-3 control-label">Government Position Project Id</label>
                <div class="col-sm-2">
                    <input type="number" name="government_position_project_id" id="government_position_project_id" class="form-control" value="{{$model['government_position_project_id'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-3 col-sm-6">
                    ...
                    <a class="btn btn-default" href="{{ url('/government_position_project_purs') }}"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
                </div>
            </div>
        </form>
