...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_staff    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_staffs'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="gender" id="gender" class="form-control" value="{{$model['gender'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
