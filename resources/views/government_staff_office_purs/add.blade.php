...
<div class="panel panel-default">
    <div class="panel-heading">
        Add/Modify Government_staff_office_pur    </div>

    <div class="panel-body">
                
        <form action="{{ url('/government_staff_office_purs'.( isset($model) ? "/" . $model->id : "")) }}" method="POST" class="form-horizontal">
            {{ csrf_field() }}
            ...
            @endif
                ...
                <div class="col-sm-2">
                    <input type="number" name="government_staff_office_id" id="government_staff_office_id" class="form-control" value="{{$model['government_staff_office_id'] or ''}}">
                </div>
            </div>
                                                                                                            <div class="form-group">
